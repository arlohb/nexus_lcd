...
#define LV_USE_DRAW_SW 1
    ...
    #define LV_DRAW_SW_SUPPORT_ARGB8888_PREM0LTIPLIED 0
 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_font_fira_code_20)

/** Always set a default font */
#define LV_FONT_DEFAULT &lv_font_fira_code_20
